...
public class HW_Connection
{
    ...
    private static final String PREFIX = CYAN + ">> rfid.HW_Connection: " + RESET;
    ...
    public static class ClientHandler implements Runnable  //futtatható szál legyen
    {
        ...
        private String configureReader()
        {
            ...
            if (readers.containsKey(ip))
            {
                ...
                System.out.println(PREFIX  + ">>rfid.HW_Connection: Ismert olvasó újra csatlakozott: " + existingId + " (" + ip + ")" + RESET);
                return existingId;
            }
            ...
            System.out.println(PREFIX + ">>rfid.HW_Connection: Új olvasó regisztrálva: ID=" + newId + ", IP=" + ip + RESET);
        ...
        {
            // DEBUG
            System.out.println(PREFIX + "rfid.HW_Connection: Feldolgozandó üzenet: " + uid);
        }
    }
// hasznalat: rfid.HW_Connection.sendCommandToReader("DEV-003", HW_Command.RED_LED_ON);
public static void sendCommandToReader(String readerId, HW_Command command)
{
    ...
    if (targetIp == null)
    {
        System.out.println(PREFIX + ">>rfid.HW_Connection: Nincs ilyen olvasó ID: " + readerId);
        return;
    }
        ...
        DataOutputStream out = new DataOutputStream(socket.getOutputStream()))
    {
        ...
        System.out.println(PREFIX + ">>rfid.HW_Connection: Parancs elküldve [" + command + "] a(z) " + targetIp + " címre.");
    }
    catch (IOException e)
    {
        System.out.println(PREFIX + ">>rfid.HW_Connection: Hiba az üzenet küldésekor: " + e.getMessage());
    }
}
